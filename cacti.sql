...
CREATE TABLE `automation_ips` (
  ...
  `network_id` int(10) unsigned,
  `pid` int(10) unsigned,
  `status` int(10) unsigned,
  `thread` int(10) unsigned,
...
CREATE TABLE `automation_networks` (
  ...
  `day_of_week` varchar(45) COMMENT 'The days of week to run in crontab format',
  `month` varchar(45) COMMENT 'The months to run in crontab format',
  `day_of_month` varchar(45) COMMENT 'The days of month to run in crontab format',
  `monthly_week` varchar(45),
  `monthly_day` varchar(45),
  ...
  `rerun_data_queries` char(2) COMMENT 'Rerun data queries or not for existing hosts',
  PRIMARY KEY (`id`),
...
CREATE TABLE graph_templates_graph (
  ...
  auto_scale_opts tinyint(1) NOT NULL default '0',
  t_auto_scale_log char(2) default '',
  auto_scale_log char(2),
  t_scale_log_units char(2) default '',
  scale_log_units char(2),
  t_auto_scale_rigid char(2) default '',
  auto_scale_rigid char(2),
  t_auto_padding char(2) default '',
  auto_padding char(2),
  t_base_value char(2) default '',
  base_value mediumint(8) NOT NULL default '0',
...
CREATE TABLE `poller` (
  ...
  `dbsslkey` varchar(255),
  `dbsslcert` varchar(255),
  `dbsslca` varchar(255),
